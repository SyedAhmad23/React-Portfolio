...
const Contact = () => {
    return (
        <div id="contact" className="max-w-[1040px] m-auto md:pl-20 p-4 py-16">
            <h1 className=" py-4 text-4xl text-center font-bold text-blue-900">Contact</h1>
            <form action="https://getform.io/f/9ed4618d-2a95-48ba-9382-05f85de8746d" method="POST" encType="multipart/form-data">
